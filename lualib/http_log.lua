...
local ok, err, errcode, sqlstate = db:connect{
  host = os.getenv("HTTP_LOG_DB_HOST"),
  port = tonumber(os.getenv("HTTP_LOG_DB_PORT")),
  database = os.getenv("HTTP_LOG_DB_NAME"),
  user = os.getenv("HTTP_LOG_DB_USER"),
  password = os.getenv("HTTP_LOG_DB_PASSWORD"),
